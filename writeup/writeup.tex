...
All the tests are performed on a 2-GPU H-100 SXM5 instance.  The sequence length is fixed at 256 and the batch size varies from 2
...
This is because larger microbatches make training more computation bound.
...
Here, we clearly see the overlap of NCCL communication kernels with CUDA compute kernels.
\end{enumerate}
...
pass, have smaller buckets toward the end, and syncronize each bucket as soon as it is full, i.e. gets all the parameters assigned to it.
